...
const Reels = (_a) => {
    ...
    const { videoRefs, flatListRef, currentIndex, likedVideos, toggleLike, handleViewableItemsChanged, screenHeight, playVideoAtIndex, pauseVideoAtIndex, navigation, muted, toggleMute, childRef, setIsBottomSheetOpen, isBottomSheetOpen, setVideoItemHeight, videoItemHeight, } = (0, useReels_1.default)();
