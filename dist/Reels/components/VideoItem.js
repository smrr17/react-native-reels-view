...
//           const duration = Platform.OS === "ios" ? 150 : 100;
//           translateY.value = withTiming(-height * 0.7, { duration });
//         }
//       );
...
//         });
//       } else {
//         translateY.value = withTiming(hp(100), {
//           duration: 400,
//         });
//       }
//     }, [isVisible]);
...
//       }
//     };
//     const onGestureEvent = useCallback((event: GestureHandlerGestureEvent) => {
//       "worklet";
//       const { translationY } = event.nativeEvent as any;
...
//         "worklet";
//         const { translationY, velocityY, state } = event.nativeEvent as any;
//         if (state === State.END) {
//           // If dragged down more than 20% of height or with fast velocity, close
//           const shouldClose = translationY > hp(20) || velocityY > 500;
//           if (shouldClose) {
//             translateY.value = withTiming(hp(100), { duration: 300 });
//             runOnJS(onClose)();
//           } else {
...
//             <CustomText style={styles.commentTitle}>Comments</CustomText>
//           </View>
//           <FlatList
//             data={comments}
...
//               >
//                 <CustomText style={styles.sendText}>Post</CustomText>
//               </TouchableOpacity>
//             </View>
//           </View>
//         </Animated.View>
